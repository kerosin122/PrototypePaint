Shader "Hidden/DrawOnTexture"
{
    Properties
    {
        ...
        _BrushTransparency("Brush Transparency", float) = 1
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed4 color = lerp(albedo, _BrushColor, saturate((canDraw + tex2D(_BrushTexture, brushUVs).r) - 1) * _BrushTransparency);
                return color;
            }
